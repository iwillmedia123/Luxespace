...
export const metadata: Metadata = {
  title: "Luxury Real Estate Blog & Market Insights | Luxespace Properties",
  description: "Stay updated with the latest Dubai property trends, news, and market analysis.",
};
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 pb-16">
      <div className="border-b border-luxury-border/20 pb-4 mb-8">
        ...
        <h1 className="text-4xl font-serif text-white mt-1">Blog</h1>
      </div>
      <div className="h-96 border border-dashed border-luxury-border/30 rounded-lg flex items-center justify-center text-gray-500 text-sm">
        Blog Content Architecture (Ready to receive content)
      </div>
    </div>
  );
}
